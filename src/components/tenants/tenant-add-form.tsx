    ...
    <div className="flex-1 overflow-y-auto p-8 lg:p-12">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-on-surface-variant max-w-2xl leading-relaxed">Register a new tenant into the PropAgent ecosystem. Assign them to a property and unit for streamlined communication and case management.</p>
        </div>
        {/* Form Canvas */}
