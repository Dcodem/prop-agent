    ...
    <form action={formAction} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          type="text"
          required
          className="w-full bg-surface-container-lowest border-0 ring-1 ring-outline-variant/30 rounded-lg px-4 py-2.5 text-sm text-on-surface focus:ring-2 focus:ring-accent transition-all"
