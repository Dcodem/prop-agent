  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <button
        ...
        className="bg-surface-container-lowest rounded-2xl p-5 card-shadow border border-outline-variant/10 flex items-center gap-4 text-left hover:ring-2 hover:ring-primary/30 transition-all cursor-pointer"
      >
        <div className="w-10 h-10 rounded-xl bg-surface-container-high flex items-center justify-center">
          <span aria-hidden="true" className="material-symbols-outlined text-on-surface-variant">pending_actions</span>
        </div>
        <div>
        ...
        {openCases > 0 && (
          <div className="ml-auto flex items-center text-primary text-[10px] font-bold">
