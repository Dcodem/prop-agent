      ...
      <div>
        ...
        <header className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
          ...
          <div className="flex gap-3">
            ...
            <Link href={`/vendors/${vendor.id}/edit`} className="px-6 py-2.5 bg-accent text-on-accent font-semibold text-sm rounded shadow-md hover:bg-accent/90 transition-colors flex items-center gap-2">
