  ...
  return (
    <div className="max-w-5xl mx-auto px-8 py-12">
      ...
      <div className="mb-12">
        ...
        <h1 className="text-4xl font-extrabold text-[#191c1e] tracking-tight mb-4" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Add New Vendor</h1>
      ...
      <form action={formAction} className="space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          <div className="lg:sticky lg:top-24">
            <h2 className="text-xl font-bold text-[#191c1e] mb-1" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Quick Registration</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start pt-8 border-t border-slate-100">
          <div className="lg:sticky lg:top-24">
            <h2 className="text-xl font-bold text-[#191c1e] mb-1" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Company Information</h2>
          ...
          <div className="lg:col-span-2 bg-white rounded-xl p-8 shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="col-span-2">
                ...
                />
                {state?.error?.name && (
                  <p className="text-xs text-red-600 mt-1">{state.error.name[0]}</p>
                )}
              </div>
              <div>
                ...
                {state?.error?.trade && (
                  <p className="text-xs text-red-600 mt-1">{state.error.trade[0]}</p>
                )}
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          <div>
            <h2 className="text-xl font-bold text-[#191c1e] mb-1" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Contact Details</h2>
          ...
          <div className="lg:col-span-2 bg-white rounded-xl p-8 shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                />
                {state?.error?.phone && (
                  <p className="text-xs text-red-600 mt-1">{state.error.phone[0]}</p>
                )}
              </div>
              <div className="col-span-2">
                ...
                />
                {state?.error?.email && (
                  <p className="text-xs text-red-600 mt-1">{state.error.email[0]}</p>
                )}
              </div>
              <div className="col-span-2">
                ...
                <textarea
                  className="w-full bg-[#f2f4f6] border-0 border-l-2 border-transparent focus:border-[#006872] focus:ring-0 rounded-lg p-3 text-[#191c1e] transition-all"
                  placeholder="123 Industry Blvd, Suite 400..."
                  rows={3}
                ></textarea>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          <div>
            <h2 className="text-xl font-bold text-[#191c1e] mb-1" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Rates &amp; Availability</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    name="rateNotes"
                    className="w-full bg-[#f2f4f6] border-0 border-l-2 border-transparent focus:border-[#006872] focus:ring-0 rounded-lg p-3 pl-8 text-[#191c1e] transition-all"
                    placeholder="0.00"
                    type="number"
                  />
                  {state?.error?.rateNotes && (
                    <p className="text-xs text-red-600 mt-1">{state.error.rateNotes[0]}</p>
                  )}
                </div>
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          <div>
            <h2 className="text-xl font-bold text-[#191c1e] mb-1" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Compliance &amp; Insurance</h2>
        ...
        {/* Form Actions */}
        <div className="flex items-center justify-end gap-4 pt-8 mt-12 border-t border-slate-200">
          <Link href="/vendors" className="px-8 py-3 bg-[#e6e8ea] text-[#191c1e] font-semibold rounded-lg hover:bg-[#e0e3e5] transition-colors active:scale-95">Cancel</Link>
          <button type="submit" disabled={isPending} className="px-10 py-3 bg-gradient-to-br from-[#006872] to-[#00838f] text-white font-bold rounded-lg shadow-xl shadow-cyan-900/10 active:scale-95 transition-all disabled:opacity-50">
