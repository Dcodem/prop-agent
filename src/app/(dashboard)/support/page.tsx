...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "When a tenant submits a maintenance request, PropAgent's AI analyzes the message to classify urgency, category, and required trade. It automatically assigns vendors based on your preferences and dispatches communications — all within seconds.",
  },
  {
...
const STEPS = [
  ...
  { icon: "assignment", title: "Start managing cases", desc: "Let PropAgent handle incoming maintenance requests automatically." },
];
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-8">
      ...
      <div className="mb-12">
        ...
        <p className="text-on-surface-variant">Everything you need to get the most out of PropAgent.</p>
      </div>
      ...
      <footer className="mt-16 text-center border-t border-outline-variant/20 pt-8">
        <p className="text-[10px] text-outline font-bold uppercase tracking-[0.3em]">PropAgent Support Center</p>
      </footer>
    </div>
  );
}
